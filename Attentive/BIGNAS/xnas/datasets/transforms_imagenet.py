...
def get_randomResizedCrop(train_crop_size=224, train_min_scale=0.08, interpolation=Image.BICUBIC):
...
def build_default_transform(
    train_crop_size=224, train_min_scale=0.08, test_scale=256, test_crop_size=224, interpolation=Image.BICUBIC
):
...
def build_imagenet_auto_augment_tf_transform(
    policy='v0', train_crop_size=224, train_min_scale=0.08, test_scale=256, test_crop_size=224, interpolation=Image.BICUBIC
):
