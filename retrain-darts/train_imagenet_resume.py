...
#    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.decay_period, gamma=args.gamma)
    ...
    #model_path = "/userhome/lz/code/PC-darts/imagenet_resumeeval-try-20221104-084103/checkpoint.pth.tar"
    model_path = "/userhome/lz/code/PC-darts/imagenet_resume_2eval-try-20221107-075043/checkpoint.pth.tar"
    res = torch.load(model_path)
    start_epoch = res['epoch']
    model.load_state_dict(res['state_dict'])
    best_acc_top1 = res["best_acc_top1"]
