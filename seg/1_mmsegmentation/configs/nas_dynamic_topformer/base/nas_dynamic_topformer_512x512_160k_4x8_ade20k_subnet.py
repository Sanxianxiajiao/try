...
subnet = dict(
    width=[16, 16, 24, 64, 112, 152], 
    depth=[1, 2, 2, 2, 2], 
    kernel_size=[3, 3, 3, 5, 3], 
    expand_ratio=[1, 5, 3, 3, 6], 
    num_heads=[8, 10, 6, 10], 
    key_dim=[16, 12, 12, 16], 
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',  # wandb
            init_kwargs={'project': 'mmseg_dynamic_topformer_subnet'},
            by_epoch=False)
    ]
)    
...
work_dir = 'output/new_nas_dynamic_topformer/'
gpu_ids = range(0, 1)
auto_resume = False
