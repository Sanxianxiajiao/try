...
model = dict(backbone= dict(fix_backbone=False, 
                            fix_trans=True, 
                            supernet=dict(pretrained='ckpt/nas_dynamic_topformer/base/imagenet/fix_trans/last.pth.tar')))
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',  # wandb
            init_kwargs={'project': 'mmseg_dynamic_topformer'},
            by_epoch=False)
    ]
) 
