...
unfixed_ckpt='ckpt/nas_dynamic_topformer/base/ade20k/unfixed/latest.pth'
fix_backbone_ckpt='ckpt/nas_dynamic_topformer/base/ade20k/fix_backbone/latest.pth'
fix_trans_ckpt='ckpt/nas_dynamic_topformer/base/ade20k/fix_trans/latest.pth'
...
work_dir = 'output/nas_dynamic_topformer/base/unfixed'
