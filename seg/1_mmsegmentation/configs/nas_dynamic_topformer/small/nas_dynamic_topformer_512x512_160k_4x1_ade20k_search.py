...
model = dict(backbone=dict(fix_backbone=False, fix_trans=False, supernet=dict(SIM=dict(norm_cfg=norm_cfg))),
             ...
             sync_bn=False)
constraint_flops=1.2
unfixed_ckpt='ckpt/nas_dynamic_topformer/small/ade20k/unfixed/latest.pth'
fix_backbone_ckpt='ckpt/nas_dynamic_topformer/small/ade20k/fix_backbone/latest.pth'
fix_trans_ckpt='ckpt/nas_dynamic_topformer/small/ade20k/fix_trans/latest.pth'
...
work_dir = 'output/nas_dynamic_topformer/small/unfixed'
