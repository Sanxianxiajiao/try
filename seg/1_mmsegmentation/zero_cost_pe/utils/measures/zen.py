...
@measure("zen", bn=True)
def compute_zen_score(net, inputs,img_metas, targets, loss_fn=None, split_data=1,
    ...
    with torch.no_grad():
        for repeat_count in range(repeat):
            ...
            output = net.forward_before_global_avg_pool(input, img_metas)
            mixup_output = net.forward_before_global_avg_pool(mixup_input, img_metas)
